...
export class NotificationEngine {
  ...
  /**
   * Update which sessions alert (and whether the main session waits for
   * subagents).
   * @param mode - new notification scope.
   */
 ...
 * @param text - detail to truncate.
 * @param max - maximum length, including the ellipsis.
 * @returns the text unchanged when short enough, otherwise an ellipsized prefix.
 */
