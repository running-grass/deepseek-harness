...
// The settings-scope contract is plugin-local (upstream dissolved the
// dsh-client-runtime re-export in dsh-client-ui-settings).
import type { SettingsScopeSnapshot } from './settings-scope.ts'
import {
