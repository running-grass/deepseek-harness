 ...
 * plugin-local `SettingsScope` contract in `settings-scope.ts` (snapshot +
 * subscribe + mutate/set/unset — the `dsh-client-runtime` contract, kept after
 * upstream dissolved the client re-export) so the apply world and the section
